...
from models.Neighborhood import AdamicAdar
import pandas as pd
import numpy as np
...
"""
Sandbox for Acadmic-Adar algorithm link prediction
"""
...
def train_test():
    ...
    print("=> Initializing Adamic-Adar model...")
    model = AdamicAdar()
...
def load_test():
    ...
    print("=> Initializing AdamicAdar model...")
    model = AdamicAdar()
    ...
    with open("results/adamicadar.txt", 'w') as f:
    ...
    with open('results/adamicadar.txt', 'a') as f:
