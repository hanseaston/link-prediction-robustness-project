...
from models.Neighborhood import CommonNeighbor
import pandas as pd
import numpy as np
...
"""
Sandbox for Common Neighbor algorithm link prediction
"""
...
def load_test():
    ...
    with open("results/commonneighbor.txt", 'w') as f:
    ...
    with open('results/commonneighbor.txt', 'a') as f:
